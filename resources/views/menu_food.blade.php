                        ...
                        <div
                            ...
                            <div class="relative mb-3 rounded-2xl">
                                <img class="max-h-60 w-full object-cover transition-transform duration-300 transform group-hover:scale-105"
                                    src="https://media-cdn.tripadvisor.com/media/photo-p/29/48/a7/e8/culinary-quintessence.jpg"
                                    alt="">
                            ...
                            <div class="flex justify-center items-center w-full">
                                <div class="text-center">
                                    ...
                                    <!-- food name & price -->
                                    <div class="mt-2">
                                        <p class="text-xl font-serif font-semibold no-underline">Món ăn thượng
                                            hạng</p>
                                        <p class="text-xl font-serif font-medium no-underline">1.000.000 VND</p>
                                    </div>
                                </div>
                            </div>
                        </div>
