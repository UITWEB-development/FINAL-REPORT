<x-layout title="Admin Signin" class="bg-[#f7ebd3] h-screen">
            ...
            <form action="" class="flex flex-col items-center gap-5">
                <div class="w-full">
                    ...
                    <div class="border-solid border-b-2 border-black px-4 flex gap-5 items-center mt-2">
                        ...
                        <input type="email" name="email" id="email" required class="w-full border-none bg-[#FADAA3] outline-none text-[5cqmin]">
                    </div>
                </div>
                <div class="w-full">
                    ...
                    <div class="border-solid border-b-2 border-black px-4 flex gap-5 items-center mt-2">
                        ...
                        <input type="password" name="password" id="password" required class="w-full border-none bg-[#FADAA3] outline-none text-[5cqmin]"> 
                    </div>
                </div>
