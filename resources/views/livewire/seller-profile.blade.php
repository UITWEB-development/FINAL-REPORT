    ...
    <section class="relative">
        <div class="relative pt-16 pb-32 flex content-center items-center justify-center min-h-[70vh]">
            <div class="absolute top-0 w-full h-full bg-center bg-cover group"
                style="background-image: url('https://th.bing.com/th/id/OIP.ZJ1xzTKdVbk6dH-iN3kFOgHaE8?w=720&h=480&rs=1&pid=ImgDetMain');">
                <div class="absolute inset-0 h-full w-full bg-black/65 flex flex-col justify-center items-center">
                    <div class="relative text-center">
                        <h2
                            ...
                            {{ $is_profile_exist ? 'Lorem ipsum dolor sit, amet consectetur adipisicing elit.' : 'Welcome ' . auth()->user()->name . ', please create your restaurant profile to be available on the platform!' }}
                        </h2>
                    </div>
                </div>
                <div wire:click="$dispatch('openModal', { component: '{{$is_profile_exist ? 'edit-restaurant-profile' : 'add-restaurant-profile'}}' })"
        ...
        @if ($is_profile_exist)
            ...
            <livewire:google-map-show></livewire:google-map-show>
        @endif
    </section>
</div>
