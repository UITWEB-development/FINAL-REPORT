<form wire:submit="edit">
    <div class="w-full h-[85.8vh]  px-7 py-14 overflow-y-auto">
        ...
        <div>
            <label for="name" class="block mb-2 text-lg  text-gray-900 dark:text-white font-semibold">Restaurant
                Name</label>
            <input wire:model="restaurant_name" type="text" name="restaurant_name" id="restaurant_name"
        ...
        <div>
            <label for="phone" class="block mb-2 text-lg font-semibold text-gray-900 dark:text-white">Phone
                Number</label>
        ...
        <div class="mb-5 flex md:flex-row md:items-center md:justify-between md:flex-nowrap md:gap-0 flex-col gap-2">
            <div class="flex items-center">
                <label for="opentime" class="w-full md:w-32 font-bold mb-2 md:mb-0">Opening time</label>
                <x-flat-pickr wire:model="opening_time" name="opening_time" :options="[
                    'enableTime' => true,
                    'noCalendar' => true,
                    'dateFormat' => 'H:i',
                    'time_24hr' => true,
                    ...
                    class="h-9 flex-1 rounded-lg w-40" />
            </div>

            <div class="flex items-center">
                <label for="closetime" class="w-full md:w-32 font-bold mb-2 md:mb-0">Closing time</label>
                <x-flat-pickr wire:model="closing_time" name="closing_time" :options="['enableTime' => true, 'noCalendar' => true, 'dateFormat' => 'H:i', 'time_24hr' => true, 'minuteIncrement' => 1]" format="hh:mm"
                    class="h-9 flex-1 rounded-lg w-40" />
            </div>
        ...
        <div class="text-center">
            <button
                class="bg-[#cd853f] hover:bg-[#7e5832] text-white font-bold py-1 px-4 w-full h-12 flex justify-center items-center text-lg">Save
            </button>
        </div>
