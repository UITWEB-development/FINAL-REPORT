<div x-on:toast.window="toast($event.detail.message, $event.detail)" x-data x-init="
    window.toast = function(message, options = {}){
        ...
        if (typeof options.expand != 'undefined') {
            window.dispatchEvent(new CustomEvent('set-toasts-layout', { detail: { layout: 'expanded' }}));
        }
