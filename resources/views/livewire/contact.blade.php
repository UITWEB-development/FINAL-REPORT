    ...
    <div class="mx-auto max-w-7xl px-4  sm:px-6 lg:px-8 ">
        <div class="mb-4">
            <div class="mb-6 max-w-3xl text-center sm:text-center md:mx-auto md:mb-6">
                ...
                <h2
                    class="font-heading mb-4 font-bold tracking-tight text-gray-900 dark:text-white text-2xl sm:text-4xl">
                    Get in Touch
                </h2>
                <p class="mx-auto mt-4 max-w-3xl text-base text-gray-600 dark:text-slate-400">GOUCHILL wants to bring an
                    effective and proactive marketing tool to every restaurant and store.
                </p>
            </div>
        </div>
        <div class="flex items-stretch justify-center">
            <div class="grid md:grid-cols-2">
                <div class="h-fit max-w-6xl p-5 md:p-12">
                    <p class="mt-3 mb-12 text-lg text-gray-600 dark:text-slate-400">
                        ...
                        Please contact us to have your questions answered and further contribute to GOUCHILL's progress.
                    </p>
                    <ul class="mb-6 md:mb-0">
                        <li class="flex">
                            <div class="flex h-10 w-10 items-center justify-center rounded bg-[#E19041] text-gray-50">
                            ...
                            <div class="ml-4 mb-4">
                                ...
                                <p class="text-gray-600 dark:text-slate-400">Quarter 6, Linh Trung ward, Thu Duc city,
                                </p>
                                <p class="text-gray-600 dark:text-slate-400">Ho Chi Minh city</p>
                            </div>
                        </li>
                        <li class="flex">
                            <div class="flex h-10 w-10 items-center justify-center rounded bg-[#E19041] text-gray-50">
                            ...
                            <div class="ml-4 mb-4">
                                <h3 class="mb-2 text-lg font-medium leading-6 text-gray-900 dark:text-white">Phone
                                    number</h3>
                                <p class="text-gray-600 dark:text-slate-400">0xxxxxxxxxx</p>
                        ...
                        <li class="flex">
                            ...
                            <div class="ml-4 mb-4">
                                ...
                                <p class="text-gray-600 dark:text-slate-400">websitegouchill@gmail.com</p>
                                <!-- <p class="text-gray-600 dark:text-slate-400">Monday - Friday: 08:00 - 17:00</p>
                                <p class="text-gray-600 dark:text-slate-400">Saturday &amp; Sunday: 08:00 - 12:00</p> -->
                            </div>
                        </li>
                        ...
                        <div class="mb-6">
                            <div class="mx-0 mb-1 sm:mb-4">
                                <div class="mx-0 mb-1 sm:mb-4">
                                    <label for="name" class="pb-1 text-xs uppercase tracking-wider"></label>
                                    <input type="text" id="name" autocomplete="given-name" placeholder="Your name"
                                        class="mb-2 w-full rounded-md bg-[#F9F9F9] border border-gray-400 py-2 pl-2 pr-4 shadow-md dark:text-gray-300 sm:mb-0"
                            ...
                            <div class="mx-0 mb-1 sm:mb-4">
                                <label for="textarea" class="pb-1 text-xs uppercase tracking-wider"></label><textarea
                                    id="textarea" name="textarea" cols="30" rows="5" placeholder="Write your message..."
                                    class="mb-2 w-full rounded-md bg-[#F9F9F9] border border-gray-400 py-2 pl-2 pr-4 shadow-md dark:text-gray-300 sm:mb-0"></textarea>
                            </div>
                        </div>
                        <div class="text-center">
                            <button type="submit"
                                class="w-full bg-[#CD853F] text-white px-6 py-3 font-xl rounded-md sm:mb-0">Send
                                Message</button>
                        </div>
                    </form>
                </div>
