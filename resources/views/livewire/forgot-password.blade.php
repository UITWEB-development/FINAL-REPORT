<div class="flex justify-center items-center h-[85.8vh]">
    <div class="w-[80%] md:w-[60%] lg:w-[70%] xl:w-[38.6%]  bg-[#fadaa3] p-[3.5cqmin] rounded-xl flex flex-col gap-[2cqmin] max-h-[90%]">
        <form wire:submit="send">
            ...
            {{-- Submit Button  --}}
            <div class ='mb-[4cqmin]'>
                <input type="submit" value="Send email" class="flex items-center justify-center w-full rounded-lg border-2 font-bold bg-[#cd853f] outline-none border-none text-white hover:bg-[#9e6a35] active:bg-[#9e6a35] text-[3cqmin] h-[7.5cqmin]">
            </div>
