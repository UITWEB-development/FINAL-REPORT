    ...
    <div class="px-4 sm:px-20 z-10">
        <div class="sm:flex sm:items-center sm:space-x-5 pt-10">
            <div class="flex justify-center sm:justify-start">
                <img class="h-24 w-24 rounded-full sm:h-32 sm:w-32" src="https://images.pexels.com/photos/56866/garden-rose-red-pink-56866.jpeg" alt="Profile Picture">
            </div>
            <div class="mt-6 sm:mt-0 sm:flex sm:items-center sm:space-x-6 sm:pb-1 flex-1">
                <div class="min-w-0 flex-1" style="overflow: visible;">
                    <h1 class="text-5xl font-bold text-black text-center sm:text-left">Tung Nguyen</h1>
                </div>
            </div>
        </div>
        ...
        <div x-data="{ selectedTab: 'groups', open: false, hover: null }" class="w-full mt-6">
            ...
            <div class="my-10">
                        ...
                        <div class="space-y-5 ">
                            <div class="relative p-4">
                                <div class="flex flex-col sm:flex-row pb-4 md:space-x-60 text-2xl md:text-4xl">
                                    ...
                                    <p class="mt-1 sm:mt-0 sm:w-2/3 overflow-hidden text-ellipsis whitespace-nowrap">aaaaaaaaaaaa</p>
                                </div>
                                <div class="flex">
                            ...
                            <div class="relative p-4">
                                <div class="flex flex-col sm:flex-row pt-10 pb-4 md:space-x-60 text-2xl md:text-4xl">
                                    ...
                                    <p class="mt-1 sm:mt-0 sm:w-2/3 overflow-hidden text-ellipsis whitespace-nowrap">bbbbbbbbbbbbbbbbbbba</p>
                                </div>
                                <div class="flex">
                                    <span class="border-b border-slate-500 opacity-50 block w-full"></span>
                                </div>
                ...
                <!-- Order History Tab -->
                <div x-show="selectedTab === 'likes'" id="tabpanelLikes" role="tabpanel" aria-label="likes" class="px-4 sm:px-10 md:px-20 lg:px-32 xl:px-52 py-10 w-full">
