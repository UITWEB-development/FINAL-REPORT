<div wire:ignore x-data="{position: $wire.entangle('position')}" x-on:location_updated="position.lat = $event.detail.lat; position.lng = $event.detail.lng; console.log(position)">
