...
<body class="font-roboto-slab ">
    ...
    <nav x-data="{ mobileMenuIsOpen: false }" @click.away="mobileMenuIsOpen = false"
        class=" bg-[#eccc95] flex items-center justify-between gap-4 px-6 py-4" aria-label="penguin ui menu">
        <!-- Brand Logo -->
        ...
        <!-- Search -->
        <div
            class="relative flex mr-auto w-full max-w-64 flex-col gap-1 text-slate-700 dark:text-slate-300 active:border-white" id="search-container">
        ...
        <ul class="hidden items-center gap-4 flex-shrink-0 sm:flex">
            <li><a href="/"
                    class="font-bold text-orange-600 underline-offset-2 hover:text-orange-600 focus:outline-none focus:underline dark:text-orange-600 dark:hover:text-orange-600"
                    aria-current="page">Home</a></li>
            <li><a href="/about-us"
                    class="font-bold underline-offset-2 hover:text-orange-600 focus:outline-none focus:underline dark:text-orange-600 dark:hover:text-orange-600">About
                    Us</a></li>
            <li><a href="/contact"
                    class="font-bold  underline-offset-2 hover:text-orange-600 focus:outline-none focus:underline dark:text-orange-600 dark:hover:text-orange-600">Contact</a>
            </li>
            <!-- User Pic -->
